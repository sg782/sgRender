...
impl Triangle {
    ...
    pub fn new(
        ...
        let points: Vector3<Vector2<f32>> = Vector3::new(
            Vector2::new(x0,y0),
            Vector2::new(x1,y1),
            Vector2::new(x2,y2),
        );
    ...
    pub fn sort_vertices(v: &Vector3<Vector2<f32>>) -> Vector3<Vector2<f32>> {
        ...
        let out: Vector3<Vector2<f32>> = Vector3::new(
            v1, v2, v3,
        );
